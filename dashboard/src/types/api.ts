...
export interface Membership {
  ...
  // You might want to create some utility types for common operations
  export type DayNumber = 1 | 2 | 3 | 4 | 5 | 6 | 7;
  export type DayKey = `day_${DayNumber}`;
  
  // Helper type to get the type of a plan's day
  export type PlanDay = Plan['days'][DayKey];
  
  // Helper type for exercise types
  export type ExerciseType = RegularExercise | SupersetExercise;
  
  // Helper type for plan status
